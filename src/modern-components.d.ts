...
import { MCComponent, MCDOMChildren } from "./element";
import { Ref } from "./useRef";

export interface MCDOMAttributes<TElement = HTMLElement> {
  ref?: Ref<TElement>;
  children?: MCDOMChildren;
}
...
declare global {
  namespace JSX {
    ...
    interface DOMAttributes<TElement> extends MCDOMAttributes<TElement> {
      // Image Events
    ...
    interface HTMLAttributes<TElement> extends DOMAttributes<TElement> {
    ...
    interface IntrinsicElements {
      ...
      iframe: HTMLAttributes<HTMLFrameElement>;
